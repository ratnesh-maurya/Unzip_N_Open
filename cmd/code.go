...
var codeCmd = &cobra.Command{
	...
	Short: "Open the directory in Visual Studio Code",
	Long: `This command unzips the specified file and opens the resulting
	       folder in Visual Studio Code. Ensure Visual Studio Code is installed on your system.`,
